...
import '../../../backend/model/send_money/add_money_ssl_insert_model.dart';
...
class DepositController extends GetxController {
 ...
 /// add money ssl insert process 
  ...
  AddMoneySslInsertModel get addMoneySslInsertModel =>
      _addMoneySslInsertModel;

  // --------------------------- Api function ----------------------------------
  // add money ssl process 
  Future<AddMoneySslInsertModel>
      addMoneySslInsertProcess() async {
    _isInsertLoading.value = true;
    update();
